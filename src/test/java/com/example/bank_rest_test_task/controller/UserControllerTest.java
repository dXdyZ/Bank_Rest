...
public class UserControllerTest {
    ...
    void getUserByUsername() throws Exception {
        ...
        when(userDtoFactory.createUserDtoAndCardDtoForAdmin(any(User.class))).thenReturn(new UserDto());
    ...
    void updateUsername() throws Exception {
        ...
        when(userDtoFactory.createUserDto(any(User.class))).thenReturn(new UserDto());
